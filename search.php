...
<br/>
<a href ="BookStore.php"><h3> <= Powrót</h3></a>
<br/>
 ...
 <hr>
    ...
    <div class="products">
	  <table>
		...
		<tbody>
        <?php  
        $result = $link->query("SELECT * FROM ksiazka
            WHERE (`tytul` LIKE '%".$query."%') OR (`wydawnictwo` LIKE '%".$query."%') OR (`autor` LIKE '%".$query."%')") or die(mysql_error());
